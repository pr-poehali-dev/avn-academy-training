...
export function Dashboard({ authUser }: { authUser: User }) {
  return (
    <div className="animate-fade-in space-y-6">
      <SectionHeader title="Академия Войск Национальной Гвардии" sub={`Добро пожаловать, ${authUser.name}`} />
      ...
      <div className="bg-tactical-card border border-tactical-border p-4">
        ...
        <div className="space-y-3">
          {[
            { label: "Отработка Штраф Задержание Арестна инструкторе.", pct: 75 },
...
export function Lectures() {
  return (
    <div className="animate-fade-in space-y-6">
      ...
      <div className="bg-tactical-card border border-tactical-border p-4">
        <h3 className="font-oswald text-sm tracking-widest uppercase text-muted-foreground mb-4">Новый запрос на лекцию</h3>
        <div className="grid md:grid-cols-2 gap-3 mb-3">
          <div>
            <label className="rank-badge text-muted-foreground block mb-1">Вид лекции</label>
  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      <div className="space-y-2">
        ...
        {[
          { title: "Отработка Штраф Задержание Ареста на инструкторе", date: "22.06.2024", time: "09:00–13:00", location: "Полигон №3", status: "approved" },
          { title: "Огневая подготовка — стрельбище", date: "25.06.2024", time: "14:00–17:00", location: "Тир №1", status: "pending" },
          { title: "Физическая подготовка — полигон", date: "28.06.2024", time: "08:00–12:00", location: "Учебный лес", status: "pending" },
                    { title: "Физическая подготовка — полигон", date: "28.06.2024", time: "08:00–12:00", location: "Учебный лес", status: "pending" },
                              { title: "Физическая подготовка — полигон", date: "28.06.2024", time: "08:00–12:00", location: "Учебный лес", status: "pending" },
        ].map((p, i) => (
